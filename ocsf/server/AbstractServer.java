...
public abstract class AbstractServer implements Runnable {
   ...
   * exception thrown while closing a client is ignored. If one wishes to catch
   * these exceptions, then clients should be individually closed before calling
   * this method. The method also stops listening if this thread is running. If
   * the server is already closed, this call has no effect.
   *
